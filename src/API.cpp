 ...
 * @return the APIQuadcopter with this id or a null pointer if there is no such
 * APIQuadcopter
 */
...
/**
 * Scan for all available quadcopters and distribute them to the quadcopter
 * modules.
 *
 * @return whether the function was able to distribute all quadcopter channels
 * or or give all quadcopter modules a channel.
 */
